...
mustMatch(
  ...
  /from ['"]banri-chenguang-core\/qimen['"]/u,
...
mustMatch(
  ...
  /from ['"]banri-chenguang-core\/liuyao['"]/u,
...
mustMatch(
  'src/lib/divination/liuyao.ts',
  /banri-chenguang-core\/data\/hexagrams/u,
  'liuyao web adapter should import shared hexagram data from core',
);
mustMatch(
  'src/lib/divination/liuyao.ts',
  /banri-chenguang-core\/data\/shensha/u,
...
mustMatch(
  ...
  /from ['"]banri-chenguang-core\/bazi['"]/u,
  'bazi wrapper should import bazi APIs from the bazi domain subpath',
);
mustMatch(
  'src/lib/divination/bazi.ts',
  /from ['"]banri-chenguang-core\/bazi-dayun['"]/u,
...
mustMatch(
  ...
  /from ['"]banri-chenguang-core\/ziwei['"]/u,
  'ziwei wrapper should import chart APIs from the ziwei domain subpath',
);
mustMatch(
  'src/lib/divination/ziwei.ts',
  /from ['"]banri-chenguang-core\/ziwei-horoscope['"]/u,
...
mustMatch(
  ...
  /import\s*\{[\s\S]*toQimenText[\s\S]*\}\s*from ['"]banri-chenguang-core\/qimen['"]/u,
