...
import * as mcpCore from 'banri-chenguang-core';
import { buildListToolsPayload, buildToolSuccessPayload, executeTool } from 'banri-chenguang-core/mcp';
...
function runMeihuaUnderTimeZone(timeZone) {
  const script = `
    import { calculateMeihua } from 'banri-chenguang-core';
