...
import { BanriChenguangClientsStore } from './store.js';
import {
  getCodeChallenge,
...
export class BanriChenguangOAuthProvider implements OAuthServerProvider {
  private _clientsStore = new BanriChenguangClientsStore();
