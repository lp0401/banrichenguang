...
import { listToolDefinitions } from 'banri-chenguang-core/mcp';
...
<body>
  ...
  <div class="page">
    <div class="brand">
      <img class="brand-logo" src="${escapeAttr(logoUrl)}" alt="半日辰光" onerror="this.style.display='none'" />
    ...
    <div class="client-bar">
      ...
      <div class="client-text">
        <span class="client-name">${escapeHtml(displayName)}</span> 请求访问你的半日辰光账户
      </div>
    </div>
