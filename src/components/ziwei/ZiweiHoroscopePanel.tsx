...
import type { ZiweiCanonicalJSON, ZiweiOutput as CoreZiweiOutput } from 'banri-chenguang-core/ziwei';
import type { ZiweiHoroscopeCanonicalJSON } from 'banri-chenguang-core/ziwei-horoscope';
