        ...
        ">
            <div className="flex items-center h-16 px-4 border-b border-gray-200 dark:border-white/10 justify-between">
                <Link href="/" className="flex items-center gap-2 min-w-0">
                    <Image src="/Logo.svg" alt="半日辰光 Logo" width={28} height={28} className="rounded-md flex-shrink-0 dark:invert" />
                    <span className="font-bold text-base text-[#37352f] dark:text-[#f5f3ee] whitespace-nowrap">半日辰光</span>
                </Link>
