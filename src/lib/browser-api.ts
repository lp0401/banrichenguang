...
export const DATA_INDEX_INVALIDATED_EVENT = 'banri-chenguang:data-index:invalidate';
export const HISTORY_SUMMARY_DELETED_EVENT = 'banri-chenguang:history-summary:deleted';
export const KNOWLEDGE_BASE_SYNC_EVENT = 'banri-chenguang:knowledge-base:sync';
