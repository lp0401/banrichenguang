 ...
 * 奇门遁甲薄封装层
 *
 * Web 侧仅保留输入归一化，计算与输出结构完全以 banri-chenguang-core/qimen 为准。
 */
...
import {
    ...
    type QimenOutput,
} from 'banri-chenguang-core/qimen';
import { resolveChartTextDetailLevel, type ChartTextDetailLevel } from '@/lib/divination/detail-level';

export type { QimenCanonicalJSON, QimenOutput } from 'banri-chenguang-core/qimen';
