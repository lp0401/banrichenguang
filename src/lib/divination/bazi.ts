...
} from 'banri-chenguang-core/bazi';
import { calculateBaziDayun } from 'banri-chenguang-core/bazi-dayun';
import {
    DI_ZHI as CORE_DI_ZHI,
    calculateTenGod as calculateTenGodCore,
} from 'banri-chenguang-core/utils';
...
} from 'banri-chenguang-core/data/shensha';
import type {
    BaziFormData,
    CalendarType,
    Gender,
