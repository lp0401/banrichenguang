...
export const CUSTOM_PROVIDER_STORAGE_KEY = 'banri-chenguang:custom-provider';
export const LAST_CUSTOM_PROVIDER_STORAGE_KEY = 'banri-chenguang:last-custom-provider';
export const CUSTOM_PROVIDER_CHANGED_EVENT = 'banri-chenguang:custom-provider:changed';
