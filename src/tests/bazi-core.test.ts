...
import { DI_ZHI, getDiShi, STEM_ELEMENTS, TIAN_GAN, ZHI_WUXING as BRANCH_ELEMENTS } from 'banri-chenguang-core/utils';
import { calculateBaziFiveElementsStats } from 'banri-chenguang-core/bazi';
import {
    HIDDEN_STEMS,
    calculateTenGod,
