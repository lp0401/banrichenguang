            ...
            <div className="max-w-3xl mx-auto px-4 py-8 relative z-10 animate-fade-in">
                ...
                <div className="hidden md:flex items-center gap-4 mb-10">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-foreground-secondary mt-1">使用半日辰光服务前请仔细阅读</p>
                    </div>
                </div>
                ...
                <div className="space-y-8">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-foreground-secondary leading-relaxed">
                                    欢迎使用半日辰光（以下简称&quot;本服务&quot;）。本服务条款是您与半日辰光之间的法律协议，规定了使用本服务的条款和条件。在使用本服务前，请仔细阅读以下条款。您使用本服务即表示您同意接受本服务条款的约束。
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="bg-background rounded-2xl border border-border/50 p-6">
                            <p className="text-sm text-foreground-secondary leading-relaxed">
                                本服务及其内容（包括但不限于文字、图片、图标、设计、代码）的知识产权归半日辰光所有或已获得合法授权。未经我们书面许可，您不得复制、修改、传播、公开展示或使用本服务的任何内容。我们尊重他人的知识产权，如果您认为您的作品被侵权，请联系我们进行处理。
                            </p>
                        </div>
                    </section>
